...
export default function AboutPage() {
  return (
    <>
      <SEO
        title="About"
        description="Learn more about Ína S. Stefánsdóttir, a UI/UX designer and frontend developer with a background in graphic design."
        url="https://portfolio-ina-s.netlify.app/about"
      />
        ...
        <section className="flex max-[750px]:flex-col justify-between items-center max-w-[1300px] max-[1050px]:mt-15 w-full">
          <Reveal className="flex flex-col gap-4 max-w-[570px] w-full">
            ...
            <p className="max-[950px]:text-sm">
              ...
              how things feel to use, not just how they look, and I approach
              every project with the user in mind.
            </p>

            <p className="max-[950px]:text-sm">
              I enjoy solving UX problems and turning ideas into intuitive,
              well-structured interfaces, then bringing them to life through
              code. I’m naturally curious and always looking to improve, whether
              that means refining details, learning new technologies, or
              exploring better solutions through feedback and iteration.
            </p>
