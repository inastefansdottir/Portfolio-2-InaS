...
export default function BidversePage() {
  return (
    <>
      <SEO
        title="BidVerse Case Study"
        description="A modern auction website built with HTML, Tailwind CSS, JavaScript, Cloudinary, and the Noroff Auction API."
        url="https://portfolio-ina-s.netlify.app/projects/bidverse"
      />
      ...
      <div>
        ...
        <div className="flex flex-col items-center px-4 sm:px-10 gap-[250px] max-[900px]:gap-25">
            ...
            <Reveal>
              <div className="flex max-[900px]:flex-col justify-between items-start max-w-[1078px] w-full mx-auto max-[900px]:gap-5">
                ...
                <div className="grid gap-5 max-w-[525px] w-full">
                  <p>
                    <span className="font-bold">BidVerse</span> was designed to
                    make auction browsing feel simple, modern, and intuitive
                    without overwhelming the user with complexity.
                  </p>
                  <p>
                    The project focused on creating a responsive frontend
                    experience powered by dynamic API data, while maintaining
                    accessibility, clarity, and smooth interaction patterns
                    across the platform.
                  </p>
                </div>
              </div>
          ...
          <div className="flex max-[900px]:flex-col justify-between items-start max-w-[1078px] w-full mx-auto max-[900px]:gap-5">
            ...
            <Reveal>
              <div className="grid gap-5 max-w-[525px] w-full">
                <p>
                  The <span>profile experience</span> was designed to function
                  as a lightweight dashboard rather than a static account page.
                </p>
                <p>
                  Users can seamlessly switch between viewing their active
                  listings and tracking bids they’ve placed, helping the
                  interface feel more interactive and personalized while keeping
                  important activity easily accessible.
                </p>
              </div>
            </Reveal>
          </div>
        ...
        <div className="flex justify-center px-4 sm:px-10">
          <section className="grid gap-[100px] max-w-[1078px] w-full mt-[250px] max-[900px]:mt-25">
            {/* Section 3 and 4 */}
            <Reveal className="flex max-[1100px]:flex-col justify-between items-start gap-[34px] max-[1100px]:gap-[100px]">
              <div className="flex-1">
                ...
                <p className="mt-5">
                  ...
                  profile views, helping users stay aware of their balance
                  without interrupting the auction flow.
                </p>
              ...
              <div className="flex-1">
                ...
                <p className="mt-8">
                  ...
                  integrates Cloudinary uploads directly into profile and
                  listing management flows.
                </p>

                <p className="mt-5">
                  Users can upload images directly from their device while the
                  application handles image hosting and URL generation behind
                  the scenes, creating a more familiar and modern experience.
                </p>
            ...
            {/* Section 5 */}
            <Reveal className="flex items-center gap-3 self-start mt-[150px] max-[900px]:mt-0">
              <span className="inline-block font-display text-[55px] leading-none text-[#6666FF]">
                5.
              </span>
        ...
        <div className="flex flex-col items-center px-4 sm:px-10 gap-[250px] max-[900px]:gap-25">
              ...
              <div className="flex max-[900px]:flex-col justify-between items-start max-w-[1078px] w-full mx-auto max-[900px]:gap-5">
                ...
                <div className="grid gap-5 max-w-[525px] w-full">
                  <p>
                    ...
                    interface with bold gradients, soft shadows, and clean
                    spacing to create a more contemporary take on auction
                    platforms.
                  </p>
                  <p>
                    Consistency across cards, buttons, typography, and component
                    styling helped establish a recognizable visual identity
                    while keeping the interface intuitive and easy to navigate.
                  </p>
                </div>
              </div>
          ...
          <Reveal>
            <h3 className="self-center text-center text-3xl text-[#D8D8FF] max-w-[500px] w-full">
              Designed to make auction interactions feel lightweight, social,
              and intuitive.
            </h3>
          </Reveal>
          ...
          <Reveal>
            <div className="flex max-[500px]:flex-col gap-[30px]">
              ...
              <div className="grid gap-5 max-w-[550px] w-full flex-1">
                <p>
                  BidVerse helped me explore how visual design, frontend logic,
                  and user interaction work together in an API-driven
                  application.
                </p>
                <p>
                  The project strengthened my understanding of responsive
                  layouts, profile states, bidding flows, image upload handling,
                  and designing clear UI feedback for different user actions. It
                  also pushed me to think more carefully about how small
                  details, such as credit visibility, placeholder images,
                  search, and profile organization, can make a platform feel
                  more polished and intuitive.
                </p>
                <p>
                  Overall, BidVerse became an important step in developing my
                  own frontend style while building a more complete and
