...
export default function ShopPage() {
  return (
    <>
      <SEO
        title="Online Shop Case Study"
        description="A React and TypeScript ecommerce project with product browsing, search, sorting, cart functionality, and checkout confirmation."
        url="https://portfolio-ina-s.netlify.app/projects/shop"
      />
        ...
        <div className="flex flex-col items-center mt-[250px] max-[900px]:mt-25 px-4 sm:px-10 gap-[250px] max-[900px]:gap-25">
          ...
          <section className="flex max-[900px]:flex-col justify-between items-start max-w-[1078px] w-full max-[900px]:gap-10">
            ...
            <Reveal className="grid gap-5 max-w-[525px] max-[900px]:max-w-full w-full">
              ...
              <p>
                For this assignment, I created a simple online shop that uses
                the Noroff API to display products and support a functional
                shopping experience. While the visual design was kept minimal,
                the project gave me practice working with React components,
                TypeScript, routing, API data, and shared cart state across
                multiple pages.
              </p>
            </Reveal>
          </section>
            ...
            <div className="flex max-[1000px]:flex-col justify-between items-start gap-[34px] max-[1000px]:gap-25">
              ...
              <Reveal className="flex-1">
                ...
                <p className="mt-5">
                  ...
                  responsive grid, with each card showing key information such
                  as product image, title, description, price, and discount
              ...
              <Reveal className="flex flex-col flex-1 h-full justify-between">
                <div>
                  ...
                  <p className="mt-5">
                    The review section is read-only, but it helps make the
                    product page feel more complete by displaying the review
