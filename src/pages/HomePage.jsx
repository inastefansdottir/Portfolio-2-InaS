...
export default function HomePage() {
  ...
  return (
    <>
      <SEO
        title="Home"
        description="Portfolio of Ína S. Stefánsdóttir, a UI/UX designer and frontend developer creating clean, modern, and user-centered digital experiences."
      ...
      <div className="min-h-screen flex flex-col">
        <Header
          variant="dark"
          logoHidden
          className={`transition-opacity duration-700 bg-transparent ${
            showLoop ? "opacity-100" : "pointer-events-none opacity-0"
          }`}
        />

        <main className="flex-1">
          <div className="relative mx-auto mt-[-80px] min-[1050px]:min-h-screen max-[1050px]:h-[700px] max-[720px]:h-[450px] max-[720px]:mt-[0px] max-[450px]:h-[380px] w-full overflow-hidden">
          ...
          >
            ...
            >
              ...
              <Reveal>
                <div className="flex w-full justify-center gap-6 mt-[180px] mb-[300px]">
                  ...
                  <div className="grid gap-1">
                    ...
                    <p className="w-[240px]">
                      UI/UX Designer & Frontend Developer focused on creating
              ...
              <Reveal>
                <h2 className="flex justify-center text-5xl text-secondary ">
                  PROJECTS
                </h2>
              </Reveal>

              <div className="flex flex-col items-center px-4 sm:px-10">
                <div className="max-w-[1300px] w-full grid grid-cols-2 max-[1100px]:grid-cols-1 gap-[30px] my-[100px]">
                  <Reveal delay={0.05}>
                    <ProjectThumbnail
                      titleParts={[
