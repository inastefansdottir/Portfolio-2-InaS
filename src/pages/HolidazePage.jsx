  ...
  return (
    <>
      <SEO
        ...
        description="A React and TypeScript accommodation booking platform with venue search, booking flows, role-based profiles, and venue manager tools."
        url="https://portfolio-ina-s.netlify.app/projects/holidaze"
      />
      <div>
        <ProjectHero
          logo={holidazeLogo}
          ...
          <Reveal className="flex max-[900px]:flex-col max-[900px]:gap-5 justify-between items-start max-w-[1078px] w-full">
            ...
            <div className="grid gap-5 max-w-[525px] w-full">
              ...
              <p>
                ...
                product experience, from searching and booking venues to
                managing hosted listings and incoming reservations.
              </p>
            </div>
          </Reveal>
            ...
            <Reveal className="max-[1200px]:flex max-[900px]:flex-col max-[900px]:gap-5 max-[1200px]:items-start max-[1200px]:justify-between max-[1200px]:w-full">
              ...
              <div className="grid gap-5 max-w-[525px] w-full">
                ...
                <p>
                  ...
                  search on accommodation platforms. For a booking website,
                  users are more likely to search based on destination,
                  available dates, and number of guests. Because of this, I
                  built a custom frontend filtering system using React state and
                  TypeScript. This allowed venues to be filtered by location,
                  guest capacity, and date availability, creating a search flow
                  that felt more aligned with real booking behavior.
                </p>
                <p>
          ...
          <div className="flex flex-col items-center max-w-[1078px] w-full mt-[170px] gap-[250px] max-[900px]:gap-[100px]">
              ...
              <Reveal className="flex max-[900px]:flex-col max-[900px]:gap-5 justify-between items-start">
                ...
                <div className="grid gap-5 max-w-[525px] w-full">
                  ...
                  <p>
                    ...
                    capacity, amenities, and existing bookings. The calendar
                    helps users understand availability before submitting a
                    booking, reducing confusion and making the experience feel
                    more transparent.
                  </p>
                  ...
                  <p>
                    ...
                    interface guides them through selecting dates, reviewing
                    venue details, and confirming their stay in a focused flow.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="flex max-[900px]:flex-col max-[900px]:gap-5 justify-between items-start">
                ...
                <div className="grid gap-5 max-w-[525px] w-full">
                  ...
                  <p>
                    ...
                    still felt powerful enough for users hosting multiple
                    venues.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal className="flex max-[900px]:flex-col justify-between items-start gap-[34px]">
                ...
                <div className="grid gap-5 max-w-[525px] w-full flex-1">
                  <p>
                    ...
                    managing both hosted venues and reservations. This
                    role-based structure helped make the interface feel more
                    relevant to each user instead of showing everyone the same
                    generic account page.
                  </p>

                  <p>
                    For customers, the profile page focuses on clarity and
                    booking overview. For managers, it becomes more of a control
                    center for keeping track of venue activity.
                  </p>
                </div>
              </Reveal>
            ...
            <section className="flex max-[1200px]:flex-col gap-[36px]">
              <Reveal className="grid gap-10">
                ...
                <p>
                  Using modals also helped create consistency across the
                  platform. Repeated actions share similar layouts, form
                  patterns, validation feedback, and button styling, making the
                  interface feel more cohesive and predictable.
                </p>
              </Reveal>
              ...
              <Reveal className="grid gap-10">
                <div className="grid gap-5 max-w-[525px] w-full flex-1">
                  ...
                  <p>
                    These interactions were kept inside focused overlays to
                    reduce unnecessary page changes and help users stay
                    connected to their current context. For example, a manager
                    can create or edit a venue without feeling like they have
                    been taken away from the dashboard experience.
                  </p>
                </div>
              ...
              <Reveal className="flex flex-col justify-between flex-1 max-[800px]:gap-[36px]">
                <div className="grid gap-5 max-w-[525px]">
                  ...
                  <div className="grid gap-5">
                    <p>
                      The <span className="font-bold">visual direction</span>{" "}
                      for Holidaze was inspired by Scandinavian minimalism and
                      modern accommodation platforms.
                    </p>
                    <p>
                      The interface uses soft earthy colors, spacious layouts,
                      clean typography, and warm imagery to create a calm and
                      trustworthy booking experience. I wanted the design to
                      feel polished and modern without becoming cold or overly
                      minimal.
                    </p>
                    <p>
                      The style guide helped keep the experience consistent
                      across pages, especially as the project grew to include
                      customer views, manager views, forms, modals, cards, and
                      responsive layouts.
                    </p>
                  </div>
                </div>
            ...
            <Reveal className="flex max-[500px]:flex-col gap-[30px]">
              ...
              <div className="grid gap-5 max-w-[550px] w-full flex-1">
                <p>
                  Holidaze became my most complete frontend project so far
                  because it combined product thinking, visual design,
                  role-based user flows, and technical structure.
                </p>
                <p>
                  The project challenged me to think beyond individual pages and
                  instead design a connected experience where visitors,
                  customers, and venue managers each had different goals. It
                  strengthened my understanding of React, TypeScript, frontend
                  state, reusable components, and how small UX decisions can
                  make complex functionality feel simple.
                </p>
              </div>
            </Reveal>
          </div>
