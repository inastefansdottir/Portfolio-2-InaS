  ...
  return (
    <div>
      <ProjectHero
        ...
        meta={
          <>
            <span className="font-bold">CSS Frameworks</span> • HTML • Bootstrap
            Sass
          </>
        }
        description={[
        ...
        <section className="flex flex-col items-center gap-[60px]">
          <div className="flex max-[900px]:flex-col w-full max-w-[1078px] items-stretch justify-between">
            ...
            <div className="grid w-full max-w-[525px] gap-5 max-[900px]:mt-10">
              ...
              <p>
                For the CSS Frameworks assignment, I reused the same concept and
                visual identity, but rebuilt selected screens as a static
      ...
      <div className="flex flex-col items-center mt-[250px] max-[800px]:mt-25 px-4 sm:px-10 gap-[250px] max-[800px]:gap-25">
        ...
        <section className="flex max-[1100px]:flex-col justify-between max-w-[1078px] w-full">
          <div className="max-[1100px]:flex max-[800px]:flex-col max-[1100px]:justify-between max-[1100px]:items-start max-[800px]:gap-10">
            ...
            <div className="mt-10 max-[1100px]:mt-0 w-[400px] max-[1100px]:w-[525px] max-[800px]:w-full">
              ...
              <p className="mt-5">
                Pastel purple tones, rounded cards, green accents, pet imagery,
                and clean spacing helped create a cheerful social media look
        ...
        <div className="flex max-[500px]:flex-col gap-[30px]">
          ...
          <div className="grid gap-5 max-w-[550px] w-full flex-1">
            <p>
              This project was a useful exercise in adapting an existing design
              into a framework-based layout.
            </p>
            <p>
              It helped me understand how Bootstrap can speed up page structure
              and responsive design, while SASS makes it possible to keep a more
