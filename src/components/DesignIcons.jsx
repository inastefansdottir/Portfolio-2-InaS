export default function DesignIcons({ Icon, name, description }) {
  return (
    <div className="group relative w-fit">
      <Icon className="h-[53px] w-[53px] object-fit rounded-lg bg-transparent transition-all duration-300 hover:bg-primary/30" />
